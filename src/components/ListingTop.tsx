                ...
                >
                    <div className="card flex items-center p-4 gap-5 w-[50vw] max-sm:w-full">
                        <div className="h-12 w-12 p-4 rounded-full bg-white text-black flex justify-center items-center relative">
                            <Image src={'https://plus.unsplash.com/premium_photo-1701608353893-70eb1f82b0ee?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} alt="haswh" width={100} height={100} className="absolute object-fit size-full rounded-full" />
